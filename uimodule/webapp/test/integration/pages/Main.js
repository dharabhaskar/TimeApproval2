sap.ui.require([
  ...
  var sViewName = "com.infocus.TimeApproval2.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "com.infocus.TimeApproval2"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title com.infocus.TimeApproval2"
            });
        }
      }
